                                                ...
                                                <div class="tab-pane fade" id="academic_info">
                                                    <form class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <select class="form-control unit" style="width: 100%;">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span></button>
                            <h2 class="modal-title" style="text-align: center;">Duplicate Entry</h2>
                        </div>
                        <div class="modal-body">

                            <div style="text-align: center;">
                                <h3><span id="message2">This record already exist</span></h3>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div style="text-align: center;">
                                <h3><span id="message">This record has been successfull entered!</span></h3>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $('#save_student').on('click', function(){
                    ...
                    if(matric_no === "")
                    {
                        $('#message2').html("Please kindly enter a valid matric number!");
                                    $('#modal-default_big').show();
                    }else
                    {
                        $.ajax({
                            url: 'confirm_matric_no',
                            type: 'POST',
                            data: {matric_no: matric_no},
                            cache: false,
                            success: function(data){
                                if(data === "This record donot exist!")
                                {
                                    $.ajax({
                                        ...
                                        data: {first_name: first_name, last_name: last_name, other_name: other_name, email: email,
                                            ...
                                            matric_no: matric_no, academic_session: academic_session, unit: unit, department: department, faculty: faculty},
                                        cache: false,
                                        success: function(data){
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(dataRecords){
                                                    ...
                                                    $('.unit').val("Select here").trigger('change');
                                                    $('.imgsm2').attr("src", "http://192.168.0.101:8080/ProfileImage/thumbnails/team_pic1.png");
                                                },
                                                error: function(data){
                                                    //alert(data);
                                ...
                                {
                                    $('#message2').html("This matric no "+matric_no+" already exist!");
                                    $('#modal-default_big').show();
                                }
                ...
                var table2 = $('#student_table').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'image_name', 'render': function(data, type, full, meta){
                                return "<img src='http://192.168.0.101:8080/ProfileImage/thumbnails/" + data + "' class='user-image' width='50' height='50'>";
                            }},
                        {data: 'academic_session', visible: false},
                        ...
                        {data: 'gen_info_id', visible: false}
                    ]
                });
                ...
                $('.preview').click(function(e){
                    ...
                    for(var i = 0; i < lent; i++)
                    {
                        ...
                        mtag += "<td><img src='http://192.168.0.101:8080/ProfileImage/thumbnails/" + dataob[i].image_name + "' class='user-image' width='50' height='50'></td>";
                        mtag += "</tr>";
