 ...
 * @author EKPES
 */
public class AllCourseCodeServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        try
        {
            ...
            List<User> allCourseCodesNames = UserDAO.getAllCourseCodes2();
            DataTableObject dataTableObject = new DataTableObject();
            dataTableObject.setAaData(allCourseCodesNames);
