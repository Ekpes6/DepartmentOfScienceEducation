 ...
 * @author EKPES
 */
public class RetrievePersonalImage extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                if(!(email.equals("")))
                {
                    int id = UserDAO.getLecturerStaffId(email);
                    String imageName = UserDAO.getImageName(id);
                    if(!(imageName.equals("")))
                    {

                        Gson gson = new GsonBuilder().setPrettyPrinting().create();
                        String json = gson.toJson(imageName);
