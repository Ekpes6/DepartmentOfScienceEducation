 ...
 * @author EKPES
 */
public class RetrieveMyResultServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                String matric = user.getMatric_no();
                List<User> allMyResult = UserDAO.getMyResults(matric, semester);
                DataTableObject dataTableObject = new DataTableObject();
                dataTableObject.setAaData(allMyResult);
