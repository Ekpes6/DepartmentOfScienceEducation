 ...
 * @author EKPES
 */
public class GetMatricNoServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                int insert1 = UserDAO.getIdNo(fname, lname, oname);
                if(insert1 != 0)
                {
                    String matric = UserDAO.getMatricNo(insert1);
