 ...
 * @author EKPES
 */
public class SaveEditedCourseInfo extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                String credit_hrs = request.getParameter("credit_hrs").toUpperCase().trim();

                int nuId = Integer.parseInt(request.getParameter("nuId"));

                boolean insert1 = UserDAO.UpdateCourseData(course_code, course_title, credit_hrs, nuId);
                if(insert1)
                {
