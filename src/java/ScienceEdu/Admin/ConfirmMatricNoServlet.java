 ...
 * @author EKPES
 */
public class ConfirmMatricNoServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                boolean confirm = UserDAO.ConfirmMatricNo(matric_no);
                if(confirm)
                {
                    Gson gson = new GsonBuilder().setPrettyPrinting().create();
                    String json = gson.toJson("This record already exist!");
                ...
                {
                    Gson gson = new GsonBuilder().setPrettyPrinting().create();
                    String json = gson.toJson("This record donot exist!");
                    try(PrintWriter out = response.getWriter())
                    {
                        out.print(json);
                    }
