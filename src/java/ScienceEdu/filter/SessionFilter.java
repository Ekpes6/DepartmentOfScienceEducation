            ...
            throws IOException, ServletException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                if(user != null && user.getRole() != null && (user.getRole().equals(User.LECTURER) || user.getRole().equals(User.STUDENT)
                        || user.getRole().equals(User.HOD) || user.getRole().equals(User.EXAM_OFFICER) || user.getRole().equals(User.STAFF)))
                    chain.doFilter(wrappedRequest, wrappedResponse);
                else
                    wrappedResponse.sendError(403);
            }
            else
                wrappedResponse.sendRedirect("main_home?login_role=3");
        }
        catch(Throwable t)
        {
