 ...
 * @author EKPES
 */
public class AllLecturerStaffServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        try
        {
            ...
            List<User> allLecturerStaff = UserDAO.getAllLecturerStaff();

            DataTableObject dataTableObject = new DataTableObject();
            dataTableObject.setAaData(allLecturerStaff);
