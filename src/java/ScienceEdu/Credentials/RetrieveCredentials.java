...
import ScienceEdu.user.DataTableObject;
 ...
 * @author EKPES
 */
public class RetrieveCredentials extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                User user = UserDAO.GetId(email);
                if(user != null)
                {
                    int ids = user.getId();
                    List<User> SpecificImages = UserDAO.getSpecificCredentialImages(ids);
