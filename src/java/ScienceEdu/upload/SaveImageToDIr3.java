 ...
 * @author EKPES
 */
public class SaveImageToDIr3 extends HttpServlet
{
        ...
        try
        {
            ...
            if(session != null)
            {
                ...
                if(insert1)
                {
                    ...
                    String json = gson.toJson("Insertion of Lecturer/Staff data was successfull ");
                ...
                {
                    Gson gson = new GsonBuilder().setPrettyPrinting().create();
                    String json = gson.toJson("Insertion of Lecturer/Staff data was not successfull ");
                    try(PrintWriter out = response.getWriter())
                    {
                        out.print(json);
                    }
